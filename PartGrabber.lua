...
local Minimize = createButton("-", Color3.fromRGB(50, 120, 255), topbar, UDim2.new(1, -60, 0, 0), UDim2.new(0, 28, 1, 0))
local Exit = createButton("X", Color3.fromRGB(1200, 60, 60), topbar, UDim2.new(1, -30, 0, 0), UDim2.new(0, 28, 1, 0))
...
local foundPadding = Instance.new("UIPadding")
foundPadding.Parent = Found
foundPadding.PaddingLeft = UDim.new(0, 6)
foundPadding.PaddingRight = UDim.new(0, 6)
...
local twoCol = Instance.new("Frame")
twoCol.Name = "TwoCol"
twoCol.Size = UDim2.new(1, 0, 0, 24)
twoCol.BackgroundTransparency = 1
twoCol.LayoutOrder = 6
twoCol.Parent = Container
...
grab.MouseButton1Click:Connect(function()
    if Found.Text ~= ". . ." then
        ...
        task.wait(0.3)
        grab.BackgroundColor3 = Color3.fromRGB(50, 120, 255)
    else
...
rename.MouseButton1Click:Connect(function()
    if selectedPart then
        ...
        textBox.Parent = Found
        textBox.Size = UDim2.new(1, 0, 1, 0)
        textBox.Position = UDim2.new(0, 0, 0, 0)
        textBox.ZIndex = Found.ZIndex + 1
